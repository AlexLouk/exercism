...
export function remainingMinutesInOven(actualMinutesInOven) {
  console.log(`actualMinutes: ${actualMinutesInOven}`);
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  ...
  let remainingMinutes = remainingMinutesInOven(actualMinutesInOven);
  let remainingCookTime = EXPECTED_MINUTES_IN_OVEN - remainingMinutes;
  console.log(`prepTime: ${prepTime}, remaining minutes in oven: ${remainingMinutes}`);
  return prepTime + remainingCookTime;
}
